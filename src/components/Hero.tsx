  ...
  return (
    ...
    >
      <div className="text-center max-w-3xl mx-auto">
        {/* Orbiting logo */}
        <div className="relative mx-auto mb-10 h-40 w-40 sm:h-48 sm:w-48 flex items-center justify-center fade-up">
          {/* Orbit rings */}
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-4 fade-up delay-3">
          <button
            onClick={onLaunch}
            className="btn-primary px-7 py-3.5 rounded-xl text-white font-semibold tracking-wide flex items-center gap-2.5 text-sm sm:text-base"
          >
          ...
          <button
            onClick={onExplore}
            className="btn-ghost px-7 py-3.5 rounded-xl text-white/90 font-medium tracking-wide flex items-center gap-2.5 text-sm sm:text-base"
          >
