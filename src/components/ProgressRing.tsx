...
export default function ProgressRing({ percentage, completed, total, message }: ProgressRingProps) {
  ...
  const ringId = 'progressGradient';
  const glowId = 'progressGlow';
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ...
        role="img"
        aria-label={`Universe progress: ${percentage}%. ${completed} of ${total} missions completed.`}
      >
        <div className="absolute inset-0 rounded-full border border-violet-400/15 spin-slow" aria-hidden>
          <span
        ...
        <div className="absolute inset-4 rounded-full border border-dashed border-cyan-400/12 spin-rev" aria-hidden />
